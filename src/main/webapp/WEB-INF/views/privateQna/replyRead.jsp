    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
             게시물 등록 폼    -->
         <form id="operForm" action="/privateQna/replyRead">
            <div>
...
$(function(){
    ...
    $("button[data-oper='modify']").on("click",function(e){
       operForm.attr("action","/privateQna/replyModify").submit();
    ...
    $("button[data-oper='remove']").on("click",function(e){
       ...
       if(deletcheck==true){
       alert("삭제가 완료되었습니다.");
       operForm.attr("action","/privateQna/replyRemove").attr("method","post");
       operForm.submit();
       }else{
          return;
       }
